...
},{"./template":54,"empty-element":3,"page":37,"title":40}],54:[function(require,module,exports){
var yo = require("yo-yo");
var landing = require("../landing");
var translate = require("../translate");
...
function lista(items) {
  return yo`<div id="contenedor" class="container">
            <div class="row">
              <ul>
                ${ items.map(item => {
    return yo`<li id=${ item } class="col s1" onclick="playSonido(bufferLoader.bufferList);"></li>`;
  }) }
              </<ul>
            </div>
              ${ menu }
